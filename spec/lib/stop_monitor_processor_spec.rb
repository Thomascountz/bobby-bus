...
RSpec.describe StopMonitorProcessor do
  describe '.process' do
    it 'turns json into a result object' do
      ...
      expect(stop_monitor.response_timestamp).to eq(DateTime.parse('2019-05-18T14:48:25.312-04:00'))
    ...
    it 'maps two bus lines for one stop' do
      ...
      stop_monitor = StopMonitorProcessor.process(json: json)
      expect(stop_monitor.response_timestamp).to eq(DateTime.parse('2019-05-18T18:26:35.459-04:00'))
    ...
    it 'returns errors' do
      ...
      stop_monitor = StopMonitorProcessor.process(json: json)
      expect(stop_monitor.response_timestamp).to eq(DateTime.parse('2019-05-19T10:55:24.098-04:00'))
      expect(stop_monitor.error_description).to eq('No such stop: MTA NYCT_12345. No such stop: MTA_12345. No such stop: MTABC_12345.')
    end
